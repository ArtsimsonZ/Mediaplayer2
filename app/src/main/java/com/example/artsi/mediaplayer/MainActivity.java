package com.example.artsi.mediaplayer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox = (CheckBox)findViewById(R.id.checkNupp);
        toggleButton = (ToggleButton)findViewById(R.id.toggleNupp);
        radioBtton = (RadioButton)findViewById(R.id.radioNupp);
        watchVideo = (Button)findViewById(R.id.Nupp);
